...
`PASS/docs/PASS_CONSUMPTION.md` and state its produce-not-describe rule to the
taker before they start; do not confuse describing an artifact with producing it.
