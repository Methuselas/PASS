...
- Redirect attention inside the group with a head turn or a secondary line of motion when one subject needs emphasis. For example, turn a parent animal's head toward its young while placing the young on a second motion path.
