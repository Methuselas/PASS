...
## Instructions
1. Draw a simplified trunk cross-section just in front of the pelvis. Mark the vertebral body and three axis relationships: the back-to-stomach through-axis, the transverse axis, and the longitudinal axis through the vertebral bodies.
...
7. Repeat the side-view map with the second species in the comparison. Preserve the same axis logic while allowing the visible width, length, fascia, and neighboring forms to differ.
...
- Exaggerating visible swelling in the four action thumbnails even though the exercise maps function, not a fixed surface-contraction diagram.
