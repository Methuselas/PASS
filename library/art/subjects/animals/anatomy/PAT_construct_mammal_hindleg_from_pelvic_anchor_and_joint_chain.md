...
- Do not convert the common mammalian hindleg segment sequence into a claim that every species has identical angles, motion range, or external landmarks.
...
- Do not universalize one evolutionary sequence or a broad claim that the hindleg is longer than the foreleg; use the observed animal's construction and proportion.
