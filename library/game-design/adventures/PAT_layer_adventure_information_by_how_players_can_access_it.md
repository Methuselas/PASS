...
- Use the sensory channel that naturally carries the information rather than defaulting every observation to sight; audible water, smoke or food odor, surface texture, temperature, vibration, taste, and similar cues can reveal routes, resources, hazards, or nearby activity when the characters could plainly perceive them.
...
Concise read-aloud text and sensory orientation should leave room for the facilitator and players to contribute rather than scripting every reaction. Sensory access is not synonymous with vision: a stream may become actionable first through sound, a cooking fire or occupied site through smell, and unstable footing through touch or vibration. When such a cue would be obvious to the character, deliver it as information rather than hiding it behind a generic perception check. A useful information-access grammar is: description establishes the immediate decision surface, questions refine it, deliberate actions expose more, and mechanics resolve genuinely uncertain access.
