---
object_id: PAT_preserve_stable_challenge_conditions_against_reactive_difficulty_protection
object_type: pattern
name: Preserve Stable Challenge Conditions Against Reactive Difficulty Protection
library_path:
- game-design
- adventures
...
# Preserve Stable Challenge Conditions Against Reactive Difficulty Protection

## Pattern Rule
**IF** players gain an advantage through legal preparation, advancement, information, positioning, or system mastery
**THEN** let that advantage change the challenge unless an established rule, world condition, or coherent opposition response already provides a legitimate counterpressure
**ELSE** do not secretly add opposition or cancel advantages merely to restore the difficulty the designer expected.

## Do
- Define stable challenge conditions, world tiers, opposition capabilities, environmental properties, and escalation triggers before the table reveals whether the players are performing above or below expectation.
- Allow earned preparation, allies, disabled defenses, exposed weaknesses, superior positioning, or other legal advantages to make an encounter easier when that is the honest consequence of prior play.
...
## Don't
- Add or remove opposition reactively merely to restore an imagined target difficulty.
- Raise recurring opposition in lockstep with character advancement solely so every fight remains numerically equivalent.
...
- Earned advantages materially affect difficulty when no legitimate counterpressure applies.
- Recurring opposition does not automatically scale with the party without an in-world cause or explicit campaign-level purpose.
