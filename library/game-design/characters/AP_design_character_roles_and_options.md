...
13. **Make creation teach recurring play.** Use **Make Character Creation Preview Recurring Play** so the choices, tradeoffs, vocabulary, and information architecture used during creation resemble the decisions players will continue making. If the game benefits from fast starts or novice scaffolding, use **Use Editable Templates as Onboarding Scaffolds** to offer ready-to-play examples that remain editable rather than disguising fixed characters as customization.
