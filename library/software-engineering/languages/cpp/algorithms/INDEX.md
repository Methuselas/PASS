...
- [Design a Callable for an Algorithm's Value Requirements](PAT_design_a_callable_for_the_copies_an_algorithm_will_make.md) - pattern; 2 block. Tags: algorithms, cpp, efficiency, function_objects, slicing.
