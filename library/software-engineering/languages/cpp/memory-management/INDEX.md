...
- [Do Not Emulate a Class-Specific new_handler with Global State](PAT_do_not_emulate_class_specific_new_handler_with_global_state.md) - pattern; 2 block. Tags: concurrency, cpp, memory_management, new_handler.
