...
- [Disambiguate Dependent Type Names with typename](PAT_precede_nested_dependent_types_with_typename.md) - pattern; 3 rough. Tags: cpp, dependent_names, templates, typename.
