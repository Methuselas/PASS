---
object_id: AP_write_introductory_adventure_module_as_runnable_apprenticeship
object_type: ap
...
cross_links:
  - rel: supports
    target_object_id: PAT_reduce_novice_decision_load_with_safe_defaults_and_explicit_optionality
  - rel: supports
    target_object_id: PAT_partition_adventure_module_information_by_reader_role_and_reveal_state
  - rel: supports
    target_object_id: PAT_place_novice_coaching_at_first_relevant_decision
  - rel: supports
    target_object_id: PAT_fade_worked_example_into_bounded_independent_extension
reference:
...
The AP supports `PAT_reduce_novice_decision_load_with_safe_defaults_and_explicit_optionality` by making the runnable baseline the first gate; supports `PAT_partition_adventure_module_information_by_reader_role_and_reveal_state` because novice-facing explanation cannot blur operator truth with player knowledge; supports `PAT_place_novice_coaching_at_first_relevant_decision` by scheduling instruction at live judgment points; and supports `PAT_fade_worked_example_into_bounded_independent_extension` by making authorship transfer the closing phase rather than an unsupported demand at the beginning.
