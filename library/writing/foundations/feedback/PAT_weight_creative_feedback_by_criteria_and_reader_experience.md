...
## Pattern Rule
**IF** responses to a creative draft conflict or the standards behind an evaluation are unclear
**THEN** clarify the criteria, separate aesthetic preference from craft diagnosis, and weigh each response by the reader's experience, evidence, and relevance to the work's goal
**ELSE** use the understood criteria to decide which advice should guide revision
